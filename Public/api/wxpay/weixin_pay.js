    ...
    var confirmPayBtn = function(){
        $('.weixinPayBtn').click(function(){
            if (playMethod == 'weixin') {
                ...
                var orderId = 11;
                //设置微信安全支付目录
                var safe_pay_dir = 'http://www.116lyw.com/Api/Wxpay/pay/';
                //拼接请求地址
                    ...
                    if(json.status != 'ok') {
                      ...
                      WeixinJSBridge.invoke('getBrandWCPayRequest', json.wxconf, function(res){
                        ...
                        if(res.err_msg == 'get_brand_wcpay_request:cancel') {
                          ...
                          // alert("支付成功！");
                          if(a == "record"){
                              window.location.href = "http://www.116lyw.com/Home/My/MyRecord";
                          }else if(a=="neworder"){
                            window.location.href = "http://www.116lyw.com/Home/My/MyNewOrderList";
                          }else if(a=="orderguider"){
                            window.location.href = "http://www.116lyw.com/Home/My/MyOrderGuiderList";
                          }
                        } else {
